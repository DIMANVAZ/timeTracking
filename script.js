...
document.addEventListener("DOMContentLoaded", () => {
    if (LSM.wasViewed() === false){
        alert("\n Это инструмент для хронометража - фиксации и подсчёта времени. Например, вам интересно, сколько часов в день вы тратите на учёбу." +
            " Жмите на часы для старта отсчёта, для прекращения отсчёта нажмите снова. " +
            "Получившиеся интервалы сложатся. Для сохранения результата введите уникальное название и нажмите Сохранить");
